...
const UICenter = () => {
  return (
    <div className='flex-1 h-full flex flex-col  shadow-lg overflow-y-auto scrollbar-hide'>
      <div className='w-full max-w-2xl mx-auto pt-[72px] pb-4 space-y-4 px-2 sm:px-4'>
        <StoryCard />
        <MenuCard />
        <ContenuCard />
      </div>
