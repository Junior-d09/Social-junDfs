...
const UICenter = () => {
  return (
    <div className='flex-1 h-full flex flex-col bg-white shadow-lg overflow-y-auto max-w-full'>
      <div className='w-full max-w-3xl mx-auto py-4 space-y-4 px-2 sm:px-4'>
        <StoryCard />
        <MenuCard />
        <ContenuCard />
      </div>
